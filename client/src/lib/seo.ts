...
export const homeSEO: SEOData = {
  ...
  keywords: "social media tools, app opener, link opener, thumbnail downloader, image converter, image resizer, image compressor, utility tools, word counter, qr generator, password generator, age calculator, mortgage calculator, content creator tools, social media optimization, visitor conversion, subscriber growth",
  canonical: "/",
