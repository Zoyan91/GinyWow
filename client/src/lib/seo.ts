...
export const homeSEO: SEOData = {
  ...
  description: "Transform your social media presence with GinyWow's suite of free tools: App Opener for smart redirects, YouTube Thumbnail Downloader, Image Tools (Converter, Resizer), and 7+ Utility Tools. Boost engagement and convert visitors into loyal subscribers instantly.",
  keywords: "social media tools, app opener, link opener, thumbnail downloader, image converter, image resizer, utility tools, word counter, qr generator, password generator, age calculator, mortgage calculator, content creator tools, social media optimization, visitor conversion, subscriber growth",
  canonical: "/",
