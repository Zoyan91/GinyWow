...
import { Search, ChevronDown, Menu, X, Upload, Sparkles } from "lucide-react";
    ...
    <div className="min-h-screen hero-gradient relative">
      ...
      <header className="glassmorphism border-b border-white/20">
        <div className="container mx-auto px-6 h-16 flex items-center justify-between">
          {/* Logo */}
          <Link to="/">
            <h1 className="text-2xl font-bold text-white cursor-pointer hover:opacity-80 transition-opacity" data-testid="logo">
              <span className="text-white">Giny</span><span className="text-yellow-300">Wow</span>
            </h1>
          </Link>
      ...
      <section className="py-16 md:py-24 text-center animate-fade-in">
        <div className="container mx-auto px-6">
          ...
          <p className="text-xl text-white/90 mb-12 max-w-3xl mx-auto leading-relaxed">
            Create engaging thumbnails and SEO-friendly titles that boost your video clicks and grow your audience
          </p>
        </div>
      </section>

      {/* Main Tool Section - Enhanced Style */}
      <main className="glassmorphism m-6 rounded-3xl shadow-custom animate-slide-up">
        <div className="container mx-auto px-8 py-12 max-w-2xl">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              {thumbnailPreview ? (
                ...
                <motion.div 
                  ...
                  className={`w-full max-w-lg mx-auto p-12 border-2 border-dashed rounded-2xl transition-all duration-300 cursor-pointer upload-gradient shadow-custom ${
                    isDragOver 
                      ? 'border-purple-400 scale-105 shadow-glow' 
                      : uploadError 
                ...
                >
                  <div className="space-y-4">
                    <motion.div 
                      ...
                      className="w-20 h-20 bg-gradient-to-br from-purple-400 to-pink-400 rounded-full flex items-center justify-center mx-auto shadow-lg"
                    >
                      <Upload className="w-10 h-10 text-white" />
                    </motion.div>
                    <div>
                      <p className="text-gray-700 font-semibold text-xl">Upload Your Thumbnail</p>
                      <p className="text-gray-600">JPG, PNG, WebP (Max 5MB)</p>
                      <p className="text-purple-600 text-sm mt-2">Drag & drop or click to select</p>
                    </div>
                  </div>
                </motion.div>
              )}
            ...
            <div className="pt-8">
              ...
              >
                <Button 
                  className={`px-20 py-6 text-xl font-bold rounded-2xl transition-all duration-300 button-gradient text-white shadow-glow ${
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    {isOptimizing ? 'Optimizing...' : 'Generate Magic ✨'}
                  </div>
                </Button>
              </motion.div>
            </div>
      ...
      <section className="section-bg py-20">
        <div className="container mx-auto px-6 max-w-4xl">
          <motion.div 
            ...
            className="bg-white rounded-3xl p-12 shadow-custom"
          >
          <div className="text-center mb-8">
      ...
      {/* Newsletter Section */}
      <section className="newsletter-bg py-20 text-center">
            ...
            <div className="max-w-md mx-auto">
              <div className="flex flex-col sm:flex-row gap-4 mb-6">
                <input
                  ...
                  className="flex-1 px-6 py-4 rounded-2xl border-0 shadow-lg text-gray-700 focus:ring-4 focus:ring-white/30 focus:outline-none"
                  data-testid="newsletter-email-input"
                />
                <motion.button 
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className="bg-white text-purple-600 font-bold px-8 py-4 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300"
