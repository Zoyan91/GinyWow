        ...
        <div className="relative container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
          ...
          <div className="max-w-lg mx-auto">
            ...
            <div className="mt-4 sm:mt-6 text-center">
              <p className="text-xs sm:text-sm text-gray-500 flex flex-col sm:flex-row items-center justify-center gap-1 sm:gap-0">
                <svg className="w-3 h-3 sm:w-4 sm:h-4 sm:mr-2 mb-1 sm:mb-0" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z" clipRule="evenodd" />
                </svg>
                <span className="leading-relaxed px-2 sm:px-0">We respect your privacy. Unsubscribe anytime.</span>
              </p>
            </div>
          </div>
        </div>
