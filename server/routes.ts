...
import { insertThumbnailSchema, insertTitleOptimizationSchema, insertNewsletterSubscriptionSchema, insertShortUrlSchema, pdfUploadSchema, pdfMergeSchema, pdfSplitSchema, insertPdfFileSchema } from "@shared/schema";
...
const pdfUpload = multer({
  storage: multer.memoryStorage(),
  limits: {
    fileSize: 200 * 1024 * 1024, // 200MB limit for PDF tools
  },
  fileFilter: (req, file, cb) => {
    const allowedTypes = [
      'application/pdf', 
